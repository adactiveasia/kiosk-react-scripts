...
switch(process.argv[2]) {
  ...
  case 'start':
    rewireModule('@adactive/kiosk-react-scripts/scripts/start.js', loadCustomizer('./webpack.config.dev.js'));
    break;
  // The "build" script is run to produce a production bundle
  case 'build':
    rewireModule('@adactive/kiosk-react-scripts/scripts/build.js', loadCustomizer('./webpack.config.prod.js'));
    break;
